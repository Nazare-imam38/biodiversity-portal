...
async function convertSpeciesDistributionToGeoJSON() {
  try {
    const shapefilePath = join(__dirname, '..', 'data', 'Species Distribution', 'Prersence_points_wildlife_GB.shp');
    const outputPath = join(__dirname, '..', 'geojson', 'species-distribution.geojson');
    
    console.log('Converting Species Distribution shapefile to GeoJSON...');
...
convertSpeciesDistributionToGeoJSON();
