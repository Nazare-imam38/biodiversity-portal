...
async function convertBalochistanBoundary() {
  try {
    const shapefilePath = join(__dirname, '..', 'Assets', 'Balochistan', 'Balochistan.shp');
    const outputPath = join(__dirname, '..', 'geojson', 'balochistan-provincial.geojson');
    
    console.log('Converting Balochistan shapefile to GeoJSON...');
