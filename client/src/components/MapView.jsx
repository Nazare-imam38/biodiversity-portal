      ...
      >
        ...
        {Array.from(activeLayers).map((layerId) => {
          ...
          if (layer.type === 'raster' && layer.tiles) {
            ...
            if (isExternalUrl && (layerId === 'punjab-lulc' || layerId === 'pakistan-lulc' || layerId === 'sindh-lulc' || layerId === 'balochistan-lulc' || layerId === 'kp-lulc' || layerId === 'kp-forest' || layerId === 'forest-types')) {
