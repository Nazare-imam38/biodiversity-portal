  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4 pointer-events-none">
        <div 
          className="bg-white rounded-2xl shadow-2xl w-full max-w-[450px] p-8 pointer-events-auto"
        ...
        >
          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col">
              ...
              <div className="border border-gray-200 rounded-lg h-12 flex items-center px-3 transition-all duration-200 focus-within:border-[#159f48] focus-within:ring-2 focus-within:ring-[#159f48]/20">
                <svg 
                  height={20} 
                  viewBox="0 0 32 32" 
                  width={20} 
                ...
                <input
                  type="email"
                  className="ml-3 border-none outline-none flex-1 text-gray-700 placeholder-gray-400"
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                type="button"
                className="text-sm text-[#159f48] font-medium hover:text-[#22c55e] transition-colors cursor-pointer"
              >
                Forgot password?
              </button>
            </div>
            ...
            <button
              type="submit"
              className="mt-5 bg-[#159f48] hover:bg-[#22c55e] text-white font-medium rounded-lg h-12 w-full transition-colors duration-200 shadow-md hover:shadow-lg"
            >
              Sign In
            </button>
            ...
            <p className="text-center text-sm text-gray-700 mt-2">
              ...
              <button
                type="button"
                className="text-[#159f48] font-medium hover:text-[#22c55e] transition-colors cursor-pointer"
              >
                Sign Up
              </button>
            </p>
            ...
            <div className="flex flex-col gap-3">
              <button
                type="button"
                className="w-full h-12 border border-gray-200 rounded-lg flex items-center justify-center gap-3 font-medium text-gray-700 hover:border-[#159f48] hover:text-[#159f48] transition-all duration-200 bg-white"
              >
                <svg 
                  version="1.1" 
                  width={20} 
