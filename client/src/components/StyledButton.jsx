...
const StyledWrapper = styled.div`
  .button {
    --green-800: hsl(142, 71%, 20%);
    --green-700: hsl(142, 70%, 25%);
    --green-600: hsl(142, 71%, 45%);
    --green-500: hsl(142, 76%, 36%);
    --green-400: hsl(142, 70%, 55%);
  ...
  .button::before {
    ...
    border-radius: var(--border_radius);
    box-shadow: inset 0 0.5px hsl(142, 70%, 60%), inset 0 -1px 2px 0 hsl(142, 70%, 10%),
      0px 4px 10px -4px hsla(142 70% 10% / calc(1 - var(--active, 0))),
      0 0 0 calc(var(--active, 0) * 0.375rem) hsl(142 71% 45% / 0.75);
  ...
  .button::after {
    ...
    width: 100%;
    height: 100%;
    background-color: hsla(142 71% 45% / 0.75);
    background-image: radial-gradient(
        at 51% 89%,
        hsla(142, 70%, 60%, 1) 0px,
        transparent 50%
      ),
      radial-gradient(at 100% 100%, hsla(142, 71%, 50%, 1) 0px, transparent 50%),
      radial-gradient(at 22% 91%, hsla(142, 70%, 55%, 1) 0px, transparent 50%);
